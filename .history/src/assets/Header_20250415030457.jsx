...
import { FiSearch, FiShoppingBag } from "react-icons/fi"; // Using Feather icons
      ...
      {/* Navbar */}
       ...
       <nav className="bg-white shadow-md flex flex-col md:flex-row justify-between items-center px-6 py-4 gap-4 md:gap-0">
        ...
        <ul className="flex space-x-4 md:space-x-6 text-gray-700 text-sm font-medium">
          ...
          <li><Link to="/shoes" className="hover:text-black">Shoes</Link></li>
          <li><Link to="/modern-classics" className="hover:text-black">Modern Classics</Link></li>
